 ...
 * @LastEditTime: 2021-12-07 16:31:10
 * @LastEditors: max
 * @Description: 
...
<template>
  <div>
    ...
    <GroupForm @register="registerModal" @success="handleSuccess" />
...
<script lang="ts">
  ...
  import GroupForm from './component/GroupForm.vue;
  ...
  export default defineComponent({
    components: { BasicTable, Tag, TableAction, GroupForm, Drawer },
    setup() {
      //弹出框
