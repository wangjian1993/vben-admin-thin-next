 ...
 * @LastEditTime: 2021-11-24 17:31:35
 * @LastEditors: max
 * @Description: 
  ...
  <div>
    ...
    >
      <Tabs v-model:activeKey="activeKey">
          ...
          <Form :model="formState" :label-col="labelCol" :wrapper-col="wrapperCol">
            <template v-for="item in orgList" :key="item.OrgDimensionId">
              <FormItem :label="item.OrgDimensionName">
                ...
                />
                <Input v-else style="width: 200px" disabled />
                <Button type="primary" shape="circle" style="margin-left: 10px">
        ...
        <TabPane key="3" tab="权限角色">Content of Tab Pane 3</TabPane>
      </Tabs>
    </BasicModal>
  </div>
</template>
<script lang="ts">
  ...
  import { Tabs, Upload, Form, Input, Button } from 'ant-design-vue';
