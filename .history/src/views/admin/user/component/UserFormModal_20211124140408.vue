 ...
 * @LastEditTime: 2021-11-24 14:04:08
 * @LastEditors: max
 * @Description: 
...
<script lang="ts">
  ...
  export default defineComponent({
    components: { BasicModal, BasicForm, Tabs, TabPane: Tabs.TabPane, Upload, Icon },
    ...
    setup(_, { emit }) {
      ...
      return { registerModal, registerForm, getTitle, handleSubmit, activeKey: ref('1') };
    },
  });
</script>
