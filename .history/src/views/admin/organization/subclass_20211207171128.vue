<!--
 * @Author: max
 * @Date: 2021-11-11 13:55:15
 * @LastEditTime: 2021-12-07 17:11:28
 * @LastEditors: max
 * @Description: 
 * @FilePath: /vben-admin-thin-next-main/src/views/admin/organization/subclass.vue
-->
<template>
  <div>
    <PageWrapper dense contentFullHeight fixedHeight contentClass="flex">
      <EnterTree class="w-1/4 xl:w-1/5" />
      <BasicTable @register="registerTable" class="w-2/4 xl:w-3/5" />
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'UserList',
    components: { BasicTable, PageWrapper, EnterTree, UserList },
    setup() {
