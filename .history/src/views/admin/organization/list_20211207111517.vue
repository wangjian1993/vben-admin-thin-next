 ...
 * @LastEditTime: 2021-12-07 11:15:17
 * @LastEditors: max
 * @Description: 
...
<template>
  <div>
    ...
    <OrgFormModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts">
  ...
  import OrgFormModal from './component/OrgFormModal.vuee
  ...
  export default defineComponent({
    components: { BasicTable, Tag, TableAction, OrgFormModal, Drawer },
    setup() {
      //弹出框
