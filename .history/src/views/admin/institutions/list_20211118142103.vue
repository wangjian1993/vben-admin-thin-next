 ...
 * @LastEditTime: 2021-11-18 14:20:20
 * @LastEditors: max
 * @Description: 机构列表
...
<script lang="ts">
  ...
  import { UpDrawer } from '/@/components/UP-Drawer';
  interface FormState {
    name: string;
  }
  export default defineComponent({
    components: { BasicTable, Tag, TableAction, TypeFormModal, UpDrawer },
    setup() {
      //弹出框
