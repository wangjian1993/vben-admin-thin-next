...
<template>
  <div>
    ...
    <EnrerFormModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts">
  ...
  import EnrerFormModal from './component/EnrerFormModal.vue';
  ...
  export default defineComponent({
    components: { BasicTable, Tag, TableAction, EnrerFormModal, Drawer },
    setup() {
      //弹出框
