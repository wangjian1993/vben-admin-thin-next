 ...
 * @LastEditTime: 2021-11-22 14:25:29
 * @LastEditors: max
 * @Description: 
        ...
        updateSchema([
          {
            ...
            componentProps: {
              ...
              onChange: (e) => {
                ...
                const { SuperiorEnterName } = list.filters((item) => item.EnterId === e);
                SuperiorEnter.value.SuperiorEnterName = SuperiorEnterName;
              },
            },
          },
          {
            ...
            componentProps: {
              options: typeList,
              onChange: (e) => {
                enterTypeInfo.value = typeList.filters((item) => item.EnterTypeId === e);
              },
            },
          },
        ]);
