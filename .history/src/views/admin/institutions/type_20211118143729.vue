 ...
 * @LastEditTime: 2021-11-18 14:37:21
 * @LastEditors: max
 * @Description: 机构类型
...
<script lang="ts">
  ...
  import Drawer1 from './component/Drawer1.vue';
  export default defineComponent({
    components: { BasicTable, Tag, TableAction, TypeFormModal, Drawer1 },
    setup() {
      //弹出框
