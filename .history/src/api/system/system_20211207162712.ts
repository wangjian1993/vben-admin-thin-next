 ...
 * @LastEditTime: 2021-12-07 16:26:26
 * @LastEditors: max
 * @Description: 机构列表
...
enum Api {
  ...
  orgInfoApi = '/api/base/orginfo/', //行政组织
  orglevelApi = '/api/base/orglevel/', //组织等级
  appTypeApi = '/api/base/apptype/', //应用类型
  paramGroupApi = '/api/base/paramgroup/', //快码组
  imgUploadApi = '/api/base/upload/img', //上传图片
}
//图片上传
export function uploadFile(params) {
  return defHttp.post({ url: Api.imgUploadApi, params: params });
}
//机构类型
...
//组织等级
export function getOrgLevelList(params?: object) {
  return defHttp.get({ url: Api.orglevelApi + 'getall', params: params });
}
export function orgLevelAction(params?: object, action?: string) {
  return defHttp.post({ url: Api.orglevelApi + action, params: params });
}

//应用类型
export function getAppTypeList(params?: object) {
  return defHttp.get({ url: Api.appTypeApi + 'getall', params: params });
}
export function appTypeAction(params?: object, action?: string) {
  return defHttp.post({ url: Api.appTypeApi + action, params: params });
}

//快码组
//应用类型
export function getParamGroupList(params?: object) {
  return defHttp.get({ url: Api.paramGroupApi + 'getall', params: params });
}
export function paramGroupAction(params?: object, action?: string) {
  return defHttp.post({ url: Api.paramGroupApi + action, params: params });
}
